<div class="modal fade bd-example-modal-lg" id="displaymodalprogress" tabindex="-1" role="dialog" aria-labelledby="dataModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <table id="displayprogress" class="table table-bordered table-hover table-responsive" style="width:100%">
                  <thead>
                  <tr>
                    <th>No</th>
                  ...
                  @foreach ($inProgressTickets as $data)
                  <tr>
...
<script>
  $(document).ready(function () {
      $('#displaymodalprogress').on('show.bs.modal', function() {
        $('#displayprogress').load(document.URL + ' #displayprogress');
