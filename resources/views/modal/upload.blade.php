  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
            <form method="POST" id="imageForm1" enctype="multipart/form-data">
            @csrf
...
<script>
  ...
  $(document).ready(function () {
    $('#solveimageform').click(function (e)  {
        ...
        var formElement = document.getElementById('imageForm1'); // Assuming imageform is the ID of your form
